...
void setup(){
    ...
    pinMode(3,OUTPUT);//5,3 Motoren 3 = rechts 5 = links.
    pinMode(5,OUTPUT);
...
//Anpassung der Geschwindikeit
 ...
 Serial.println(startgeschwindikeit1);
 Serial.print(" -stargeschwindikeit1- ");
 startgeschwindikeit2 = map(startgeschwindikeit, 0, 1023, 0, 127);
 Serial.println(startgeschwindikeit2);
 Serial.print(" -start geschwindikeit 2- ");

if (entfernung < 300 && entfernung > 0){ // änderung der Geschwindikeit
     ...
     Serial.print("-angepasste geschwindikeit 1-");
     Serial.println(angespasstegeschwindikeit2);
     Serial.print(" -angepasstegeschwindikeit2-");
}
